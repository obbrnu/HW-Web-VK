...
class SettingsForm(forms.Form):
    ...
    email = forms.CharField(max_length = 50, required=False, widget=forms.EmailInput())
    ...
    class Meta:
        model = User
        fields = ["username", "email", "password0", "password", "password2"]

    def saveAvatar(self, **kwargs):
